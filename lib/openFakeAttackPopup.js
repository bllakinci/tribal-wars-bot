var targetHtml = `<textarea class="flex-grow-1" placeholder="111|111,222|222, ..." style="margin:5px 5px 5px 15px"></textarea>`;
...
function openFakeAttackPopup() {
      ...
      <div class="popup_box show" id="popup_box_fake_attack" style="width: 700px;">
        <div class="popup_box_content">
            ...
            <div class="d-flex flex-direction-row" style="max-height:300px">
                      ...
                      <tbody>
                         <tr>
                            <td class="village_overview_effect ">
                              <div class="d-flex flex-direction-row align-items-center"><input type="checkbox" class="mr-5" />Make a single attack</div>
                            </td>
                         </tr>
                      </tbody>
                   </table>
              ...
              <div>
                  <input id="target_attack" tabindex="15" class="attack btn btn-attack btn-target-action" name="attack" type="submit" value="Attack" onclick="startAttack(); return false;" />
                  <input id="target_support" tabindex="16" class="support btn btn-support btn-target-action d-none" name="support" type="submit" value="Support" />
              </div>
              <div id="fake-attack-error-text" style="padding:2px;color:red;display:none"></div>
  ...
  if (canOpenVillageList && villageListOuterHTML.indexOf('Player.getAllVillages') > -1) {
    console.log(document.querySelector('#ss-villages_list > table > tbody > tr > td > a'));
  ...
  setTimeout(() => {
    ...
    if (villageList) {
      ...
      [...document.querySelectorAll('#ss-villages_list > table > tbody > tr')].forEach(item => {
        ...
        tdElement.innerHTML = `<input type='checkbox' coordinate="${item.children[1].innerHTML}" villageId=${1} />`;
